                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1>Pieces <span class="table-project-n">dossier :</span> {{ $dossier->titreDossier }} / {{ $dossier->referenceDossier }}</h1>
                            </div>
                        </div>
                        <div class="add-product">
                            <a href=" {{ route('n_pieces') }} ">Ajouter une pièce</a>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="nom" data-editable="true">Nom du fichier</th>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{ $piece->statutPiece }} </td>
                                        <td> {{ $piece->datePiece }} </td>
                                        <td>
                                          <a href="{{ route('lecture_piece', ['dossiers_id'=> $dossier->id, 'pieces_id'=> $piece->id]) }}" data-toggle="tooltip" title="Edit" style="color: white;" class="btn btn-primary">
                                            Visionner
                                          </a>
                                        </td>
                                    </tr>
